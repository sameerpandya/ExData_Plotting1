...
plot (good_data$Voltage ~ good_data$dateTime, type = "l",  ylab = "Voltage", xlab="datetime")

plot (good_data$Global_reactive_power ~ good_data$dateTime, type = "l",  ylab = "Voltage", xlab="datetime")
